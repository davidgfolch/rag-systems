...
/**
 * Adapter bridging the domain {@link com.rag.common.repositories.VectorStore}
 * interface onto Spring AI's {@link org.springframework.ai.vectorstore.VectorStore}
 * (backed by PgVector). Maps our {@link Chunk} model to Spring AI documents for
 * storage and back for retrieval.
 *
 ...
 */
public class PgVectorStoreAdapter implements com.rag.common.repositories.VectorStore {
