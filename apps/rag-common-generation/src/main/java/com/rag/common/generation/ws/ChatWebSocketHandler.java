 ...
 * The streaming seam is injected per module ({@link AnswerStreamer}), so this
 * one handler serves rag-basic, rag-advanced and rag-agentic. Per-session
 * disposal cancels the underlying LLM stream on disconnect or cancel.
 */
public class ChatWebSocketHandler extends TextWebSocketHandler {
    ...
    public ChatWebSocketHandler(AnswerStreamer answerStreamer, ObjectMapper objectMapper) {
        this(answerStreamer, objectMapper, null);
    }

    public ChatWebSocketHandler(AnswerStreamer answerStreamer, ObjectMapper objectMapper, Tracer tracer) {
    ...
    private void ask(WebSocketSession session, ChatRequest request) {
        ...
        Disposable disposable = answerStreamer.askStream(request.question(), topK)
