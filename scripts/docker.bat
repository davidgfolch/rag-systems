...
REM   docker.bat up-ollama       - Start base + Ollama
...
set "COMPOSE_OLLAMA=-f docker/docker-compose.yml -f docker/docker-compose.ollama.yml"
...
if "%CMD%"=="up" (
    ...
    echo Starting base + Ollama services...
    ...
    echo Starting all services ^(observability + SonarQube + Ollama^)...
